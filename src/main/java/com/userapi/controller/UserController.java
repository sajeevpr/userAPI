...
public class UserController {
    ...
    public UIResponse createUser(@RequestBody User user) {
        ...
        try {
            ...
            return UserApiUtil.getErrorResponse(ABCError.TECH_ERROR.getErrorCode(), "Error While creating user");
        }
    }
    ...
    public UIResponse listUsers() {
            ...
            try {
                ...
                log.error("Exception : {}", e);
                return UserApiUtil.getErrorResponse(ABCError.TECH_ERROR.getErrorCode(), "Error While listing user");
            }
    }
    ...
    public UIResponse getUser(@PathVariable(value="id") String id) {
        ...
        try {
            ...
            log.error("Exception : {}", e);
            return UserApiUtil.getErrorResponse(ABCError.TECH_ERROR.getErrorCode(), "Error handling getUser Request");
        }
    }
    ...
    public UIResponse getUserByEmail(@PathVariable(value="email") String email) {
        ...
        try {
            ...
            log.error("Exception : {}", e);
            return UserApiUtil.getErrorResponse(ABCError.TECH_ERROR.getErrorCode(), "Error handling getUserByEmail Request");
        }
    }
